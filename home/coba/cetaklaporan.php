...
if( isset($_POST['submit']) ){
        ...
        $nomorawal = stripslashes($_POST['nomorawal']);
        $nomorawal = mysqli_real_escape_string($con, $nomorawal);
        $nomorakhir = stripslashes($_POST['nomorakhir']);
        $nomorakhir = mysqli_real_escape_string($con, $nomorakhir);
        ...
        if(cek_header($pilihanheader, $con) != 0 ){
            ...
            cetakpdf($result['nama_instansi'],$result['alamat_instansi'],$result['telepon_instansi'],$result['fax_instansi'],$result['laman_instansi'],$result['email_instansi'],$result['logo_instansi'],$result['penanggung_jawab'], $nomorawal, $nomorakhir);
                ...
                <?php if($error != ''){ 
                    ...
                    if($sukses != ''){
                        ...
                        <div style="width:900px;margin-top:30px;">
                            <div class="form-row">
                                <div class="col">
                                  <input type="text" class="form-control" placeholder="Nomor awal" id="nomorawal" name="nomorawal">
                                </div>
                                <div class="col">
                                  <input type="text" class="form-control" placeholder="Nomor akhir" id="nomorakhir" name="nomorakhir">
                                </div>
                              </div>
...
<?php
function cetakpdf($nama,$alamat,$telp,$fax,$web,$email,$logo,$pjawab,$nomal,$nomak){
